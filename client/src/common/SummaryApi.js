...
getProduct : { url : '/api/product/get', method : 'get' },
    ...
    updateOrderAddress : { url : '/api/order/update-address', method : 'put' },
    razorpayOrder : { url : '/api/order/razorpay', method : 'post' },
    razorpayVerify : { url : '/api/order/razorpay-verify', method : 'post' },
    partialCodOrder : { url : '/api/order/partial-cod', method : 'post' },
    partialCodVerify : { url : '/api/order/partial-cod-verify', method : 'post' },
    ...
    getBannersByPlacement : { url : '/api/banner/get', method : 'get' },
    ...
    codeAgentNewSession   : { url : '/api/code-agent/session/new', method : 'post' },
    codeAgentChat         : { url : '/api/code-agent/chat', method : 'post' },
    codeAgentApplyBatch   : { url : '/api/code-agent/apply-batch', method : 'post' },
