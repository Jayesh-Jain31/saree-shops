...
const AddAddress = ({close, inline = false}) => {
    ...
    const formContent = (
        <div className={inline ? '' : 'bg-white p-4 w-full max-w-lg mt-8 mx-auto rounded'}>
            {!inline && (
            ...
            <form className={inline ? 'grid gap-3' : 'mt-4 grid gap-3'} onSubmit={handleSubmit(onSubmit)}>
