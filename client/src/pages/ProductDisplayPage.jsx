      ...
      <section className="container mx-auto px-4 pb-10 pt-2 grid lg:grid-cols-2 lg:gap-10 max-w-full overflow-x-hidden min-w-0">
        ...
        <div className="pt-3 lg:pt-0 w-full min-w-0">
          ...
          <div className="mt-5">
            ...
            {displayStock !== 0 && (
              <div className="mt-4 w-38 sm:w-65">
        ...
        {/* ============ RATINGS & REVIEWS ============ */}
        <div id="reviews-section" className="col-span-1 lg:col-span-2 mt-8 scroll-mt-4 min-w-0">
          <div className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-7 shadow-sm min-w-0">
        ...
        {data?._id && (
          <div className="col-span-1 lg:col-span-2 mt-8 min-w-0">
        ...
        {data?._id && (
          <div className="col-span-1 lg:col-span-2 mt-6 px-2 min-w-0">
