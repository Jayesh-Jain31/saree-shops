import{j as e,v as D,a0 as z,ad as S,ae as C,J as P,D as n,af as T,p as E}from"./index-JFnWeE79.js";import{r as f,c as I,L as u}from"./react-vendor-Dt2ouSKP.js";import"./redux-vendor-BjsoHN6Y.js";import"./axios-vendor-DsPaXkF5.js";import"./ui-vendor-B--rFs1Q.js";const L=()=>{const[c,o]=f.useState(!1);return f.useEffect(()=>{const a=setTimeout(()=>o(!0),2800);return()=>clearTimeout(a)},[]),e.jsxs("div",{className:"truck-scene",children:[e.jsx("div",{className:"road",children:e.jsx("div",{className:"road-line"})}),e.jsxs("div",{className:"truck",children:[e.jsxs("div",{className:"cab",children:[e.jsx("div",{className:"windshield"}),e.jsx("div",{className:"headlight"}),e.jsx("div",{className:"beam"})]}),e.jsx("div",{className:"body",children:e.jsx("span",{className:"cargo-icon",children:"🛍️"})}),e.jsx("div",{className:"wheel wheel-front"}),e.jsx("div",{className:"wheel wheel-rear"})]}),e.jsxs("div",{className:`success-badge ${c?"visible":""}`,children:[e.jsx("span",{children:"🎉"}),e.jsx("span",{className:"badge-text",children:"Order Placed!"})]}),e.jsx("style",{children:`
        .truck-scene {
          position: relative;
          width: 100%;
          height: 90px;
