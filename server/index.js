...
app.use(cors({
    origin: (origin, callback) => {
        ...
        if (allowedOrigins.includes(origin) || origin.endsWith('.vercel.app') || origin.endsWith('.replit.dev') || origin.endsWith('.repl.co') || origin.endsWith('.razorpay.com') || origin.endsWith('.northflank.app')) {
